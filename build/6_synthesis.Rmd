...
<div class = "notice">
Now it was time to put the pieces together and determine...What do these patterns tell us about host specificity? 
</div>
<p></p>

##  Phylogenetic inference

One of the first things we wanted to know was *where else have these microbes been found*, or more specifically, where else have these *sequences* been found? To get at this question we searched the publically available databases for similar sequences and then used phylogenetic inference to assess similarity. 
...
itol_tree <- svgPanZoom("SVG_INPUT/Figure_3_TreeA_2.svg", 
...
itol_tree_legend <- knitr::include_graphics("SVG_INPUT/Figure_3_Legend_A.svg")
itol_tree_legend
```
...
## Are ASVs & host traits correlated?
...
host_tree <- knitr::include_graphics("SVG_INPUT/collapse_tree.svg", 
                                     dpi = 300)
host_tree
```
