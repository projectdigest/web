...
<p id = "opennote">
This pipeline is <span class="paper">exactly how we processed our data</span>. This however is not meant to be a  tutorial and we  only provide minimal annotation.
</p>
