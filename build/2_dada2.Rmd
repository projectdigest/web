...
<p id = "opennote">
This pipeline is <font size ="5">exactly how we processed our data</font>. This however is not meant to be a  tutorial and we  only provide minimal annotation.
</p>
...
Here we combine the replicate runs Run01 and Run02, and then add in Run03. We followed [this recipe](https://benjjneb.github.io/dada2/bigdata_paired.html){target="_blank"} for merging samples. Run time is also displayed after this step.
