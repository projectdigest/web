...
This site has two purposes. First, I wanted to provide a comprehensive workflow that will allow anyone to reproduce the work we did for this study. This includes easy access to code and raw data. It also includes stuff that worked and stuff that didn't. Second, I wanted to have a reference source that will help me (and anyone else) generate a similar resource for other projects. Moving forward I want to have all of my projects be web based and the more I document now the easier it will be later. And this page especially is an <span class="callout">evergreen document</span> meaning that I will continue to update it.
