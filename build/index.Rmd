---
title: "ProjectDIGEST <br/> <small>Intestinal microbes: an axis of functional diversity among large marine consumers</small>"
output:
  html_document:
    toc: false
    code_folding: none
...
>The banner contains images of the 5 species examined in this study. From left to right these are: *Acanthurus bahianus/Acanthurus tractus*, *Acanthurus coeruleus*, *Scarus taeniopterus*, and *Sparisoma aurofrenatum* (see below for image credits). It also contains some images of figures from the paper and in the middle, part of a huge bony fish phylogeny. If you click on the banner you can see the full tree. 
