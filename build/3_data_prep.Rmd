...
<p id = "opennote">
<span class="callout">First we prep the microbial data</span>. Before we conduct any analyses we need to prep our datasets and working environment. This includes curating sample, removing contaminants, and creating  phyloseq objects.
</p>
