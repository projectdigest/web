...
<p id = "opennote">
This document contains all seven supplementary <font size="5">tables</font>, <font size="5">figures</font>, and <font size="5">methods</font> for the paper. Tables are horizontally scrollable. You can sort tables and download (or copy) the data. Some tables contain external hyperlinks.
</p>
...
<center><font size="4" color="red">Column descriptions</font></center>
